  ...
  for (const line of lines) {
    ...
    if (section === 'Cash Report') {
      ...
      if (label === 'Ending Cash') {
        // Formato: Cash Report,Data,Ending Cash,Base Currency Summary,9222.024144732,...
        // El valor puede estar en cols[3] o cols[4] dependiendo del formato
        const amount = parseFloat(cols[4]) || parseFloat(cols[3])
        if (!isNaN(amount) && amount !== 0) cashBalance = amount
      }
    }
  }
